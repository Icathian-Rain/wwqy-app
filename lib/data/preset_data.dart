...
class PresetData {
  ...
  static const List<GameMap> valorantMaps = [
    ...
    GameMap(id: 'icebox', gameId: valorantId, name: '极地寒港'),
    GameMap(id: 'breeze', gameId: valorantId, name: '热带乐园'),
    GameMap(id: 'fracture', gameId: valorantId, name: '天漠之峡'),
    GameMap(id: 'haven', gameId: valorantId, name: '隐世修所'),
    GameMap(id: 'pearl', gameId: valorantId, name: '深海遗珠'),
  ...
  static const List<Agent> valorantAgents = [
    ...
    Agent(id: 'fade', gameId: valorantId, name: '蚀影', role: '先锋'),
